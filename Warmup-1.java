...
public String front3(String str) {
   ...
   else return  (front = str.substring(0,3)) + front + front;
...
public String front22(String str) {
   ...
   // String end  = "";
    ...
    start = str.substring(0, str.length() );
   return start + str + start;   
...
public boolean mixStart(String str) {
  ...
  if((str.length() >= 3) && str.substring(1,2).equals("i") && str.substring(2,3).equals("x"))
   return true;
...
public int close10(int a, int b) {
   ...
   int difference2 = Math.abs(10 - b);
   int difference = Math.abs(10 - a);
...
public String endUp(String str) {
     ...
     if(str.length() >= 3)
     {
       ...
       last = str.substring(str.length()-3,str.length());
       first = str.substring(0,str.length() - 3);
      
       return first + last.toUpperCase();
     }
     
     last = str.toUpperCase();
     return last;
}
